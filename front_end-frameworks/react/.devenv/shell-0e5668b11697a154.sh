...
export mesonFlags
outputBin='out'
DEVENV_RUNTIME='/run/user/1000/devenv-2bf1a01'
...
prefix='/nix/store/z4ly7asfn2wj72li5lhrhlwyy63pfwig-devenv-shell-env'
...
NIX_LDFLAGS='-rpath /nix/store/z4ly7asfn2wj72li5lhrhlwyy63pfwig-devenv-shell-env/lib '
export NIX_LDFLAGS
shellHook='
...
mkdir -p /run/user/1000/devenv-2bf1a01
ln -snf /run/user/1000/devenv-2bf1a01 /home/clement/Code/Holberton/front_end-frameworks/react/.devenv/run
...
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/clement/Code/Holberton/front_end-frameworks/react:"* ]]; then
...
DEVENV_TASK_FILE='/nix/store/zaq797fwrmr6spkyk6x3zxs7pyrp998p-tasks.json'
export DEVENV_TASK_FILE
out='/nix/store/z4ly7asfn2wj72li5lhrhlwyy63pfwig-devenv-shell-env'
export out
CXX='g++'
export CXX
depsBuildTarget=''
...
outputDevman='out'
NIX_CFLAGS_COMPILE=' -frandom-seed=z4ly7asfn2 -isystem /nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev/include -isystem /nix/store/hd5lacx31z6c2nsv2jarqx7irsfc1ih0-nodejs-26.5.0/include -isystem /nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev/include -isystem /nix/store/hd5lacx31z6c2nsv2jarqx7irsfc1ih0-nodejs-26.5.0/include'
...
DEVENV_STATE='/home/clement/Code/Holberton/front_end-frameworks/react/.devenv/state'
export DEVENV_STATE
NM='nm'
export NM
...
DEVENV_ROOT='/home/clement/Code/Holberton/front_end-frameworks/react'
export DEVENV_ROOT
OBJDUMP='objdump'
export OBJDUMP
...
NIX_STORE='/nix/store'
export NIX_STORE
DEVENV_DOTFILE='/home/clement/Code/Holberton/front_end-frameworks/react/.devenv'
...
exec /tmp/devenv-envhAOhom/script 
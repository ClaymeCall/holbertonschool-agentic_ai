const steps = [
  {
    ...
    description:
      "The agent interprents the user's objective and identifies what needs to be achieved.",
  },
  {
    number: 2,
  ...
  },
  {
    ...
    description:
      "It can interact with APIs, databases, files, interface, or other services to complete tasks.",
  },
  {
    number: 4,
